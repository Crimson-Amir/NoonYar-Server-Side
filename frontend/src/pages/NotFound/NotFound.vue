<template>
    <div
        ...
        dir="rtl"
    >
        <!-- 🌑 نویز پس‌زمینه برای حس بافت دیوار -->
        <div
        ...
        <div class="relative z-10 flex flex-col items-center">
            ...
            <!-- دکمه‌ها با استایل متفاوت (Outline Neon) -->
            <div
